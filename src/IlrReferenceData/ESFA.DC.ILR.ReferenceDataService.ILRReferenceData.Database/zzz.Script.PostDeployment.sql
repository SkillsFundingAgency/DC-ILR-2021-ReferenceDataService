...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'AFinType_10', N'W', N'An ''end-point assessment price'' is missing. An end point assessment price is required for all apprenticeship standards. Once you''ve agreed an ''end point assessment price'' with the assessor, you must record it on t) ')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'DelLocPostCode_03', N'W', N' ''Delivery location postcode'' is wrong. You must enter a valid UK postcode. If the system isn''t recognising your postcode because it''s a new build, you can temporarily use ZZ99 9ZZ. Check ''delivery l) postcode'' is correct.')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'EPAOrgID_01', N'W', N' ''End point assessment organisation'' may be wrong. It''s not a recognised organisation for the standard you''re delivering on the planned end date of the apprenticeship. Check ''end point assessment organisatio) ''planned end date'' are correct.')
GO
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'Filename_8', N'E', N'The file date/time is after today''s date/time')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'Header_2', N'E', N'The file preparation date is after today''s date')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnDelFAMType_53', N'E', N'This FAM type must not be used by grant funded providers')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnDelFAMType_62', N'W', N' ''Learning delivery FAM type'' and ''learning delivery FAM code'' is wrong. The type and code you''ve returned indicates that this learner is co-funded. But this learner''s prior attainment must be 2 or above) start of the aim to be co-funded. Check ''learning delivery FAM type'', ''learning delivery FAM code'' and ''prior attainment'' are correct.')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LLDDHealthProb_06', N'E', N' ''LLDD and health problem'' is missing. You''ve indicated that the learner feels that they have a learning difficulty and/or disability or health problem, but have not entered the any ''LLDD and health pr) details. Check ''LLDD and health problem'' is complete and correct.')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'OutGrade_03', N'W', N'The outcome grade is not valid for this level of qualification. For an entry level course that counts towards skills for life the achievement should be recorded as either EL1, EL2 or EL3, depending on the level. Ch) learning aim and learning delivery outcome are correct.')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'UKPRN_09', N'E', N'There is no apprenticeship funding relationship for this UKPRN')
