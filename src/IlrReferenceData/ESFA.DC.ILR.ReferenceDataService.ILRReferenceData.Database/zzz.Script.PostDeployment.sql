...
INSERT [dbo].[LookupSubCategory] ([ParentName], [Name], [Code], [Description], [EffectiveFrom], [EffectiveTo]) VALUES (N'LearnDelFAMType', N'DAM', N'002', N'Procured Adult Education Budget (AEB)', CAST(N'2019-08-01' AS Date), CAST(N'2099-12-31' AS Date))
...
INSERT [dbo].[LookupSubCategory] ([ParentName], [Name], [Code], [Description], [EffectiveFrom], [EffectiveTo]) VALUES (N'LearnDelFAMType', N'LDM', N'354', N'Non-apprenticeship Theatre and live events', CAST(N'2017-08-01' AS Date), CAST(N'2099-12-31' AS Date))
...
INSERT [dbo].[LookupSubCategory] ([ParentName], [Name], [Code], [Description], [EffectiveFrom], [EffectiveTo]) VALUES (N'LearnDelFAMType', N'LDM', N'363', N'Learners in receipt of low wages', CAST(N'2018-08-01' AS Date), CAST(N'2019-07-31' AS Date))
...
INSERT [dbo].[LookupSubCategory] ([ParentName], [Name], [Code], [Description], [EffectiveFrom], [EffectiveTo]) VALUES (N'LearnDelFAMType', N'LDM', N'366', N'Non-levy non-procured contract for authorised apprentices', CAST(N'2018-08-01' AS Date), CAST(N'2099-12-31' AS Date))
...
INSERT [dbo].[LookupSubCategory] ([ParentName], [Name], [Code], [Description], [EffectiveFrom], [EffectiveTo]) VALUES (N'LearnFAMType', N'MCF', N'5', N'Learner holds a pass grade for functional skills level 2 in mathematic', CAST(N'2019-08-01' AS Date), CAST(N'2099-12-31' AS Date))
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'AFinDate_01', N'E', N'The apprenticeship financial record date must not be more than one year before the start of the apprenticeship programme')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'AFinDate_02', N'W', N'The apprenticeship financial record date should not be more than one year after the Learning planned end date of the apprenticeship programme')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'AFinDate_03', N'E', N'The apprenticeship financial record date must not be after the file preparation date')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'AFinDate_12', N'E', N'The apprenticeship financial record date should not be more than one year after the Learning planned end date of the apprenticeship programme')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'AFinType_06', N'E', N'There must not be consecutive TNP records with the same Type and Amount')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'AFinType_09', N'E', N'The Apprenticeship Financial Record must be returned for this learning aim')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'AFinType_10', N'W', N'The end-point assessment price should be returned')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'AFinType_12', N'E', N'''Price record'' is missing: You must enter the price details for all apprenticeship-funded programmes. Check ''price record'' is complete and correct.')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'AFinType_13', N'E', N'''Price record'' is missing: You must enter the price details from the start of all apprenticeship funded programmes. Check ''price record'' is complete and correct and check that the date of the ''apprenticeship finanical record'' matches the ''learning start date'' .')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'AgreeId_01', N'W', N'The agreement identifier is not valid')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'AgreeId_02', N'E', N'The agreement identifier has been incorrectly returned')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'AimType_06', N'W', N'The Learning start date for the Core aim should not be in the following teaching year')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'CampId_01', N'W', N'The Campus identifier is not valid')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'CampId_02', N'W', N'The UKPRN is not the same as recorded in the Header')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'CompStatus_03', N'E', N'''Learning actual end date'' is missing: You''ve indicated that the learner has completed their learning aim but haven''t provided a ''learning actual end date''. Check ''learning actual end date'' and ''completion status'' are complete and correct.')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'CompStatus_04', N'E', N'''Learning delivery outcome status'' is missing: You''ve indicated that this learner has completed their learning aim but haven''t provided details of the outcome. Check ''learning delivery completion status'' and ''learning delivery outcome'' are complete and correct.')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'CompStatus_05', N'E', N'The Completion status is not valid for this Outcome')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'ConRefNumber_02', N'E', N'The Contract reference number must be returned for ESF funded aims')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'ContPrefType_03', N'W', N'The Contact preference type and code is not valid for this Learning start date')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'DateOfBirth_02', N'W', N'The Date of birth should be returned')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'DateOfBirth_03', N'W', N'The learner is 100 or over')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'DateOfBirth_28', N'W', N'The learner is under 19 and the planned duration of the programme does not reach the required minimum duration of an apprenticeship')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'DateOfBirth_29', N'W', N'The learner is 19 or over and the planned duration of the programme does not reach the required minimum duration of an apprenticeship')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'DateOfBirth_39', N'E', N'The learner is 19 or over and the actual duration of the programme does not reach the required minimum duration of an apprenticeship')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'DelLocPostCode_03', N'W', N'The Delivery location postcode is not valid')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'DelLocPostCode_17', N'E', N'The Delivery location postcode is not valid in the local authority described in the ESF Tender Specification')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'ELQ_01', N'E', N'''Equivalent or lower qualification'' is missing: You must provide details of whether the learner is aiming for an equivalent or lower level qualification than one already achieved. Check ''equivalent or lower qualification'' and ''learning aim'' are complete and correct.')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'ELQ_02', N'E', N'The ELQ is not a valid code')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'EmpId_01', N'E', N'The Employer identifier is not valid')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'EmpOutcome_04', N'W', N'The Employment outcome should not be returned where there is no Benefit status indicator')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'EmpStat_08', N'E', N'''Employment status'' is missing: You must enter details of what the learner''s employment status was prior to the learning start date for all adult and non-funded learners. Check ''employment status (dates)'' entries and ''learning aim start date'' and ''funding model'' are complete and correct.')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'EmpStat_12', N'W', N'The Employment status on the start date of an apprenticeship programme should be employed')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'EmpStat_19', N'E', N'The learner must not be employed for more than 16 hours per week at the start of the programme')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'Entity_1', N'E', N'There are no valid learners in either the Learner record or the Learner Destination and Progression record')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'EPAOrgID_01', N'W', N'The end point assessment organisation is not valid for this standard on this planned end date.')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'EPAOrgID_03', N'E', N'The End point assessment organisation has been returned but there is no record of the associated financial record.')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'Filename_1', N'E', N'The filename is not in the correct format')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'Filename_2', N'E', N'A file with the same UKPRN, collection year and date/time combination has been received before')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'Filename_4', N'E', N'The UKPRN is not valid')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'Filename_5', N'E', N'The year of collection is not the current year')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'Filename_6', N'E', N'The serial number is not a 2 digit number')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'Filename_7', N'E', N'The serial number must not be 00')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'Filename_8', N'W', N'The file date/time is after today''s date/time')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'Filename_9', N'E', N'The date/time of the file is earlier than a previous transmission for this collection')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'FundModel_06', N'E', N'''Learning aim'' is wrong: You''ve indicated that this learner is apprenticeship funded so they must be on an apprenticeship aim. Check ''funding model'' and ''learning aim'' are correct.')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnActEndDate_02', N'W', N'The Learning actual end date should be before the end of the current teaching year')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnActEndDate_03', N'E', N'The Learning actual end date must be before the end of the following teaching year')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnActEndDate_04', N'W', N'''Learning actual end date'' is wrong: The learning must have actually ended. This means that the ''learning actual end date'' must be before the date the ILR file was created. Check ''learning actual end date'' and ''file preparation date'' are correct.')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_03', N'E', N'The Learning aim reference is part of an Adult skills funded apprenticeship and is not valid in the LARS database on this Learning start date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_05', N'E', N'The Learning aim reference is Adult skills funded and is not valid in the LARS database on this Learning start date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_09', N'E', N'The Learning aim reference is not valid in the LARS database for this Funding model and this Learning start date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_10', N'E', N'The Learning aim reference is 16-19 EFA funded and is not valid in the LARS database on this Learning start date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_11', N'E', N'The Learning aim reference is Adult skills funded and is not valid in the LARS database on this Learning start date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_12', N'E', N'The Learning aim reference is Community Learning funded and is not valid in the LARS database on this Learning start date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_16', N'E', N'The Learning aim reference is not valid in the LARS database for this Funding model for a new starter on this Learning start date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_17', N'E', N'The Learning aim reference is Adult skills funded and is not valid in the LARS database for a new starter on this Learning start date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_18', N'E', N'The Learning aim reference is 16-19 EFA funded and is not valid in the LARS database for a new starter on this Learning start date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_19', N'E', N'The Learning aim reference is Community Learning funded and is not valid in the LARS database for a new starter on this Learning start date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_23', N'E', N'The Learning aim reference is not valid in the LARS database for this Funding model for this teaching year')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_24', N'E', N'The Learning aim reference is 16-19 EFA funded and is not valid in the LARS database for this teaching year')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_25', N'E', N'The Learning aim reference is Adult skills funded and is not valid in the LARS database for this teaching year')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_26', N'E', N'The Learning aim reference is Community Learning funded and is not valid in the LARS database for this teaching year')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_30', N'E', N'''Learning aim reference'' is wrong: You''ve indicated this learner is on an apprenticeship programme or traineeship (learning aim type 1). This means their ''learning aim reference'' must be ''ZPROG001''. Check ''learning aim reference'' and ''learning aim'' are correct.')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_36', N'E', N'The Learning aim reference is not valid in the LARS database for this Funding model and this Learning start date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_37', N'E', N'The Learning aim reference is not valid in the LARS database for this Funding model and this Learning start date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_38', N'E', N'The Learning aim reference is not valid in the LARS database for this Funding model for a new starter on this Learning start date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_39', N'E', N'The Learning aim reference is not valid in the LARS database for this Funding model for this teaching year')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_40', N'E', N'The Learning aim reference is not valid for an aim which is not a programme aim')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_42', N'E', N'The Learning aim reference is OLASS funded and is not valid in the LARS database on this Learning start date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_43', N'E', N'The Learning aim reference is OLASS funded and is not valid in the LARS database for a new starter on this Learning start date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_44', N'E', N'The Learning aim reference is OLASS funded and is not valid in the LARS database for this teaching year')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_45', N'E', N'The Learning aim reference is financed by an Advanced Learner Loan and is not valid in the LARS database on this Learning start date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_46', N'E', N'The learner is recorded as in receipt of JSA, ESA (WRAG), another state benefit or Universal credit, is part of a traineeship or recorded with LDM328 and this Learning aim reference is not valid in the LARS database on this Learning start date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_47', N'E', N'The Learning aim reference is financed by an Advanced Learner Loan and is not valid in the LARS database for a new starter on this Learning start date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_48', N'E', N'The learner is recorded as in receipt of JSA, ESA (WRAG), another state benefit or Universal credit, is part of a traineeship or recorded with LDM328 and this Learning aim reference is not valid in the LARS database for a new starter on this Learning start date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_49', N'E', N'The Learning aim reference is financed by an Advanced Learner Loan and is not valid in the LARS database for this teaching year')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_50', N'E', N'The learner is recorded as in receipt of JSA, ESA (WRAG), another state benefit or Universal credit, or recorded with LDM328 and this Learning aim reference is not valid in the LARS database for this teaching year')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_53', N'E', N'The Learning aim reference is not valid in the LARS database for this Funding model for this teaching year')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_54', N'E', N'The Learning aim reference is not valid in the LARS database for this Funding model for this teaching year')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_60', N'E', N'The learning aim must be Adult skills or ESF funded')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_61', N'E', N'The learning aim must be Adult skills or ESF funded')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_62', N'E', N'The learning aim must be Adult skills or Other SFA funded')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_63', N'E', N'The learning aim must be Community Learning or Local Authority Community Learning funded')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_64', N'E', N'The learning aim must be Non-funded')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_65', N'E', N'The learning aim must be Non-funded')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_66', N'E', N'The learning aim must Adult skills or Other SFA funded')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_67', N'E', N'The Learning aim reference is not valid in the LARS database for this Funding model and this Learning start date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_68', N'E', N'The Learning aim reference is not valid in the LARS database for this Funding model and this Learning start date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_69', N'E', N'The Learning aim reference is not valid in the LARS database for this Funding model for a new starter on this Learning start date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_71', N'E', N'The learning aim''s sector subject area does not match the ESF Tender Specification')
GO
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_73', N'E', N'The learning aim''s sector subject area and level does not match the ESF Tender Specification')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_74', N'E', N'The Learning aim reference is Adult skills funded and is not valid in the LARS database on this Learning start date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_75', N'E', N'The Learning aim reference is Adult skills funded and is not valid in the LARS database on this Learning start date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_76', N'E', N'The Learning aim reference is Adult skills funded and is not valid in the LARS database for a new starter on this Learning start date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_77', N'E', N'The Learning aim reference is Adult skills funded and is not valid in the LARS database for this teaching year')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_83', N'E', N'The Learning aim reference is Adult skills funded and is not valid in the LARS database for a new starter on this Learning start date')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnAimRef_88', N'W', N'The Learning aim reference is not valid in the LARS database for this Funding model and this Learning start date')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnDelFAMDateTo_02', N'W', N'The Date applies to should not be after the Learning planned end date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnDelFAMDateTo_03', N'E', N'''Date applies to'' is wrong: The date that the ''funding and monitoring'' applies to must be on or before the actual end date of the learning. Check ''date applies to'' and ''learning actual end date'' are correct.')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnDelFAMType_39', N'W', N'The FAM type LDM should be returned for this Funding model')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnDelFAMType_53', N'W', N'This FAM type must not be used by grant funded providers')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnDelFAMType_62', N'W', N'The Prior attainment is not valid for this learning aim')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnDelFAMType_63', N'W', N'The Apprenticeship contract type must not be returned for this learning aim')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnDelFAMType_64', N'E', N'''Apprenticeship contract type'' entry is missing: You''ve indicated that this learner is funded through apprenticeship funding. This means you need to enter details of the type of apprenticeship contract they have. Check ''funding model'' and ''learning delivery aim'' are complete and correct and that a ''learning delivery funding and monitoring'' entry for'' apprecticeship contract type'' has been included.')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnPlanEndDate_04', N'W', N'The Learning planned end date should not be 5 years or more after the end of the current teaching year')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LearnStartDate_06', N'W', N'The Learning start date of the apprenticeship programme must not be after the Effective to date of this apprenticeship pathway')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'LLDDHealthProb_06', N'W', N'The LLDD and Health Problem record has not been returned and the learner does consider himself or herself to have a learning difficulty and/or disability or health problem')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'MathGrade_03', N'E', N'''Learner FAM type'' is wrong: If the GCSE maths qualification is ''D'' (or 3) or below you must include a ''learner FAM type'' of ''eligibility for EFA disadvantage funding''. Check ''learner math grade'' and ''learner FAM type'' entries are correct.')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'Namespace Mismatch', N'E', N'ILR submissions must use the correct namespace')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'NETFEE_01', N'E', N'''Net tuition fee'' is missing: The ''net tuition fee'' is the fee for the student on this course this year after any financial support (such as waivers or bursaries) is taken into account. Check ''net tuition fee'' is complete and correct.')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'NETFEE_02', N'W', N'The Net tuition fee should not be greater than ?9000')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'NUMHUS_01', N'E', N'''Student instance identifier'' is missing: You must enter ''student instance identifier'' details for all HE learners from 1 August 2011. Check ''student instance identifier'' and ''learning aim start date'' are complete and correct.')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'OrigLearnStartDate_04', N'E', N'''Restart indicator'' is missing: You''ve indicated that this learner has restarted their learning by completing the ''original learning start date'' but you haven''t entered a ''learning delivery funding and monitoring type restart indicator''.  Check ''original learning start date'' and ''learning delivery funding and monitoring type'' are complete and correct.')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'OrigLearnStartDate_05', N'W', N'The Learning aim reference is not valid in the LARS database for this Funding model on this Original learning start date')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'OutGrade_03', N'W', N'The Outcome grade is not valid for this level of qualification')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'OutULN_02', N'W', N'The Unique learner number is not valid')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'PCFLDCS_02', N'E', N'''Percentage taught in the first LDCS subject'' is missing. You must enter the percentage of the academic year that the learner will spend studying the subject entered in LDCS 1 (Learning Directory Classification System). Check ''percentage taught in the first LDCS subject'' is complete and correct.')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'PlanLearnHours_01', N'E', N'''Planned learning hours'' is missing: You''ve indicated this learner either isn''t an apprentice or European Social Fund (ESF) funded or that all the learning aims are closed. This means you must provide details of the total planned timetabled hours for learning activities for the teaching year. Check ''planned learning hours'' and ''learning aim'' are complete and correct.')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'PlanLearnHours_02', N'W', N'The Planned learning hours should not be zero')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'PlanLearnHours_04', N'W', N'The sum of the Planned learning hours and the Planned employability, enrichment and pastoral hours should not be greater than 1,000 hours')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'Postcode_14', N'W', N'The Postcode is not valid')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'Postcode_15', N'E', N'The Postcode is not in the correct format')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'PostcodePrior_01', N'W', N'The Postcode prior to enrolment is not valid')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'PriorAttain_01', N'E', N'''Prior attainment code'' is missing: You must enter details of the learner''s prior attainment at the time they enrolled. Check ''prior attainment'' is complete and correct.')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'PriorAttain_02', N'W', N'The Prior attainment is not valid if the learning aim is a full level 2 or full level 3')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'PriorAttain_05', N'E', N'The Prior attainment is not valid if the programme is a higher level 4 apprenticeship')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'PriorAttain_06', N'E', N'The learner''s prior attainment does not match the prior attainment described in the ESF Tender Specification')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'PriorLearnFundAdj_02', N'W', N'The Funding adjustment for prior learning should be completed when the Restart indicator is returned')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'PriorLearnFundAdj_03', N'W', N'The Funding adjustment for prior learning field should be completed for this learning aim')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'ProgType_01', N'E', N'''Programme type'' is missing: You must include ''programme type'' details for all learning aims that are part of a wider programme (aim type 1 or aim type 3). Check ''programme type'' and ''learning aim type'' are complete and correct.')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'ProgType_04', N'E', N'The Programme type is not a valid code for this Learning start date')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'PwayCode_01', N'E', N'The Apprenticeship pathway code is not a valid code in the LARS database')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'QUALENT3_01', N'E', N'''Qualification on entry'' is missing: You must enter ''qualification on entry'' details for all HE learners from 1 August 2010. Check ''qualifications on entry'' and ''learning aim start date'' are complete and correct.')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'R107', N'W', N'There should be a Learner Destination and Progression record present')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'R108', N'E', N'There must be a Learner Destination and Progression record present')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'R115', N'E', N'The learner must not have more than one Apprenticeship Financial Record with the same Apprenticeship financial type, code and date')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'R116', N'W', N'The sum of the Apprenticeship financial payment amounts should not be less than zero')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'R29', N'E', N'All open aims that are part of a programme must have the same Framework code, Apprenticeship pathway and Standard code (if returned)')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'R59', N'W', N'The ILR file should not have more than one record with the same ULN')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'R62', N'E', N'The learning aim must not have more than one Advanced Learner Loans Bursary funding record at the same time')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'R63', N'E', N'The learner must have a core aim for this Funding model')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'R70', N'E', N'All aims that are part of an apprenticeship standard programme must have a corresponding programme aim with the same standard code.')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'R75', N'W', N'The sum of the Apprenticeship financial payment amounts should not be less than zero')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'R97', N'W', N'The learner must not have consecutive Learner Employment status records with the same Employment status, Employer identifier and Employment Status Monitoring')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'SWSupAimId_01', N'W', N'The Software supplier aim identifier is not in the correct format')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'SWSupAimId_02', N'W', N'The Software supplier aim identifier must be returned')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'TTACCOM_01', N'E', N'''Term time accommodation'' is wrong: You must enter a value from 1 to 9 (depending on where the learner is living during term time). The ILR data specification provides details of what each code should be used for. Check ''term time accommodation'' is correct.')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'TTACCOM_04', N'E', N'''Term time accommodation'' is missing: You must enter a value from 1 to 9 (depending on where the learner is living during term time). The ILR data specification provides details of what each code should be used for. Check ''term time accommodation'' is complete and correct.')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'UKPRN_06', N'E', N'You do not have a current contract for adult skills funding: You must have a contract for adult skills funding to be able to claim this type of funding. Check ''UK provider reference number'' is correct and that you have a contract in place for adult skills funding.')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'UKPRN_09', N'W', N'There is no apprenticeship funding relationship for this UKPRN')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'UKPRN_11', N'W', N'There is no apprenticeship funding relationship for this UKPRN')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'ULN_02', N'W', N'This Unique learner number should not be used')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'ULN_05', N'W', N'The Unique learner number is not valid')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'ULN_06', N'W', N'This Unique learner number should not be used')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'ULN_07', N'E', N'''Unique learner number'' (ULN) is wrong for the combination of course length with funding model and file preparation date and learning start date: The temporary learner number (9999999999) should only be used before 1 January while you wait for the learner''s ULN registration.  Check the ''unique learner number'' and ''file preparation date'' and ''funding model'' and ''learning start/end dates'' are correct.')
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'ULN_09', N'W', N'This Unique learner number should not be used')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'ULN_12', N'E', N'''Unique learner number'' (ULN) is wrong: The default learner number (9999999999) should only be used until 1 January while you wait for the learner''s ULN registration.  Check ''unique learner number'' and ''learning delivery FAM type'' are correct.')
...
INSERT [dbo].[Rules] ([Rulename], [Severity], [Message]) VALUES (N'WorkPlaceEmpId_03', N'W', N'The Work placement employer identifier should not be used')
