CREATE TABLE [ReferenceInput].[MetaData_ReferenceDataVersion] (
    ...
    [EasUploadDateTime_Id]        INT NULL,
    [Employers_Id]                INT NULL,
    ...
    CONSTRAINT [FK_ReferenceInput.MetaData_ReferenceDataVersion_ReferenceInput.MetaData_EasUploadDateTime_EasUploadDateTime_Id] FOREIGN KEY ([EasUploadDateTime_Id]) REFERENCES [ReferenceInput].[MetaData_EasUploadDateTime] ([Id]),
    CONSTRAINT [FK_ReferenceInput.MetaData_ReferenceDataVersion_ReferenceInput.MetaData_EmployersVersion_Employers_Id] FOREIGN KEY ([Employers_Id]) REFERENCES [ReferenceInput].[MetaData_EmployersVersion] ([Id]),
