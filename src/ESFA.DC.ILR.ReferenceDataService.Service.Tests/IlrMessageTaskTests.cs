...
namespace ESFA.DC.ILR.ReferenceDataService.Service.Tests
{
    public class IlrMessageTaskTests
    {
        ...
        public async Task Retrieve()
        {
            ...
            gZipFIleProviderMock.Setup(s => s.StoreAsync(referenceDataContextMock.Object.OutputReferenceDataFileKey, referenceDataContextMock.Object.Container, referenceDataRoot, false, cancellationToken)).Returns(Task.CompletedTask).Verifiable();
