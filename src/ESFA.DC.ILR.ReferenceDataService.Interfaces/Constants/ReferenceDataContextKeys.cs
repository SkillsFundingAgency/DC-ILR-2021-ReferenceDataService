namespace ESFA.DC.ILR.ReferenceDataService.Interfaces.Constants
{
    public static class ReferenceDataContextKeys
    {
        ...
        public const string FISReferenceDataVersion = "FISReferenceDataVersion";
    }
}
