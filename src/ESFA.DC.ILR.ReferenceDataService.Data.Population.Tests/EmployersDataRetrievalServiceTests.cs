...
using ESFA.DC.ILR.ValidationService.Data.Population.ReferenceData;
...
namespace ESFA.DC.ILR.ReferenceDataService.Data.Population.Tests
{
    public class EmployersDataRetrievalServiceTests
    {
        ...
        private EmployersDataRetrievalService NewService(IEmployersContext employers = null)
        {
            return new EmployersDataRetrievalService(employers);
        }
    }
}
